...
## Project Structure
    ...
    ├── harmonymerchandiser_30146  # Django project configurations
...
1. Clone this repo and `cd harmonymerchandiser_30146`
...
2. Clone this repo and `cd harmonymerchandiser_30146`
